const apiURL = 'https://api.openweathermap.org/data/2.5/forecast?lat=42.66&lon=-111.62&units=imperial&appid=cd296ba4edb3930334e2b3b8876bb180';
var day = new Date();
...
fetch(apiURL)
    ...
    .then((jsObject) => {
        ...
        document.getElementById('currently').textContent = fivedayforecast[0].weather[0].description;
        document.getElementById('hightemp').textContent = fivedayforecast[0].main.temp_max.toFixed();
        document.getElementById('humidity').textContent = fivedayforecast[0].main.humidity;
        document.getElementById('speed').textContent = fivedayforecast[0].wind.speed.toFixed();
